...
[Files]
Source: "{src}\dist\EasySpeech2Text\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "{src}\dist\EasySpeech2Text\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
